...
* 			  or even one pin.
*/
extern ERROR_STATUS_t DIO_init (DIO_Cfg_t *DIO_info);
...
* 			  or even one pin.
*/
extern ERROR_STATUS_t DIO_Write (uint8_t GPIO, uint8_t pins, uint8_t value);
...
* 			  or even one pin.
*/
extern ERROR_STATUS_t DIO_Read (uint8_t GPIO,uint8_t pins, uint8_t *data);
...
* 			  or even one pin.
*/
extern ERROR_STATUS_t DIO_Toggle (uint8_t GPIO, uint8_t pins);
