...
#define Frequncy_100HZ			100
#define ICR_VALUE_100HZ			78
#define PRESCALER_1024			0x0005
...
*/
extern ERROR_STATUS_t Pwm_Init(Pwm_Cfg_s *Pwm_Cfg);
...
*/
extern ERROR_STATUS_t Pwm_Start(uint8_t Channel,uint8_t Duty,uint8_t Frequncy);
...
*/
extern ERROR_STATUS_t Pwm_Update(uint8_t Channel,uint8_t Duty,uint8_t Frequncy);
...
*/                                  
extern ERROR_STATUS_t Pwm_Stop(uint8_t Channel);
