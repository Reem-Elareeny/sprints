 ...
 * 							
 */
extern ERROR_STATUS_t Timer_Init(Timer_cfg_s* Timer_cfg);
 ...
 * 							
 */
extern ERROR_STATUS_t Timer_Start(uint8_t Timer_CH_NO, uint16_t Timer_Count);
 ...
 * 							
 */
extern ERROR_STATUS_t Timer_Stop(uint8_t Timer_CH_NO);
 ...
 * 							
 */
extern ERROR_STATUS_t Timer_GetStatus(uint8_t Timer_CH_NO, uint8_t* Data);
 ...
 * 							
 */
extern ERROR_STATUS_t Timer_GetValue(uint8_t Timer_CH_NO, uint16_t* Data);
 ...
 * 							
 */
extern ERROR_STATUS_t Timer_SetValue(uint8_t Timer_CH_NO, uint16_t Data);
