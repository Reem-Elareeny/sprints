...
void MotorDC_Dir(En_motorType_t en_motor_number, En_motorDir_t en_motor_dir){
	switch(en_motor_number){
		case MOT_1:
			switch(en_motor_dir){
				case FORWARD:
					gpioPinWrite(MOTOR_OUT_1A_GPIO, MOTOR_OUT_1B_BIT, HIGH);
					gpioPinWrite(MOTOR_OUT_1B_GPIO, MOTOR_OUT_1B_BIT, LOW);
					break;
				case BACKWARD:
					gpioPinWrite(MOTOR_OUT_1A_GPIO, MOTOR_OUT_1B_BIT, LOW);
		...
		case MOT_2:
			switch(en_motor_dir){
				case FORWARD:
					gpioPinWrite(MOTOR_OUT_2A_GPIO, MOTOR_OUT_2B_BIT, HIGH);
					gpioPinWrite(MOTOR_OUT_2B_GPIO, MOTOR_OUT_2B_BIT, LOW);
					break;
				case BACKWARD:
					gpioPinWrite(MOTOR_OUT_2A_GPIO, MOTOR_OUT_2B_BIT, LOW);
